...
class ViewAbbonamento(object):
    objMetodi = Metodi()

    def __init__(self):
        self.controller = ControllerAbbonamento()
    ...
    def crea_abbonamento(self):
        try:
            ...
            if tipo_abbonamento != "":
                nuovo_abbonamento = Abbonamento(data_iscrizione, data_certificato_medico, tipo_abbonamento)
                self.controller.aggiungi_abbonamento_cliente(nuovo_abbonamento)
                self.objMetodi.show_popup_ok("Salvataggio effettuato!")
                self.view_abbonamento.close()
            else:
    ...
    def setupUi(self, MainWindow):
        self.view_abbonamento = MainWindow
        ...
        self.btnAnnulla.clicked.connect(self.view_abbonamento.close)
